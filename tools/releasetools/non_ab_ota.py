...
""" % bcb_dev)
  ...
  brand = target_info.GetBuildProp("ro.custom.brand")
  android_version = target_info.GetBuildProp("ro.build.version.release")
  build_id = target_info.GetBuildProp("ro.build.id")
  build_date = target_info.GetBuildProp("ro.custom.build_date")
  security_patch = target_info.GetBuildProp("ro.build.version.security_patch")
  device = target_info.GetBuildProp("ro.custom.device")
  script.PrintCustomBanner(brand, android_version, build_id, build_date,
